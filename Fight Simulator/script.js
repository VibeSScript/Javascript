...
class Magicien extends Personnage {
  constructor(pseudo) {
    super(pseudo, "magicien", 170, 90); // appelle le constructeur parent avec le paramètre
  }
...
class Guerrier extends Personnage {
  constructor(pseudo) {
    super(pseudo, "guerrier", 350, 50); // appelle le constructeur parent avec le paramètre
  }
